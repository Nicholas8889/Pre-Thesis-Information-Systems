...
const statusStyles: Record<string, string> = {
  ...
  "Ready to Prepare": "bg-warning text-strong",
  Preparing: "bg-info text-white",
  Prepared: "bg-success text-white",
...
const statusDescriptions: Record<string, string> = {
  ...
  "Ready to Prepare": "Picking List is ready for warehouse preparation",
  Preparing: "Order preparation is in progress",
  Prepared: "All items are prepared and ready for Surat Jalan",
